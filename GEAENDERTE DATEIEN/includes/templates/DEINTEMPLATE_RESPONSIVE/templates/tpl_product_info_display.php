 ...
 * @version $Id: tpl_product_info_display.php for PayPal Ratenkauf Hinweis 2022-10-18 15:39:36Z webchills $
 */
...
<?php $specials_new_products_price = (round(zen_add_tax(zen_get_products_actual_price($product_info_metatags->fields['products_id']),zen_get_tax_rate($product_info_metatags->fields['products_tax_class_id'])),2)); ?>
